...
;(function ($) {
    ...
    $.extend({
        zUIWX: function (option) {
            var zui = $('body').data("zUIWX");
            if (!zui) {
                $('body').data('zUIWX', zUIWX = new zUIWX(option));
            }
            return zui;
        }
    });

    var zUIWX = function (options) {
        var DEFAULTS = {
    ...
    zUIWX.prototype = {
        ...
        _init : function(){
            ...
            if(this.opts.postUrl==''){
                ...
                this._loadDataIfNeed().done(this._fillContent());
            }
        },
        _initScorll : function(){
            $('#'+this.opts.scrollContainer).fullpage({
                css3:true,
        ...
        _initMusicPlay:function(){
            var zui = this;
            $('#'+this.opts.playBtn).click(function(){
                if(zui.opts.playStatus=='on'){
                    $(this).children("audio").get(0).pause();
                    zui.opts.playStatus = 'off';
                    $(this).removeClass("rotating");
                }else{
                    $(this).children("audio").get(0).play();
                    zui.opts.playStatus = 'on';
        ...
        _renderPage : function(){
            ...
            if(width / height >= 320 / 486){
                ...
                leftSpace = (width / scaleFactor - 320) / 2;
            }else{
                scaleFactor = width / 320;
                topSpace =  (height / scaleFactor - 486) / 2;
            }
            if(leftSpace){
                $(".content").css({marginLeft:leftSpace});
            }
            if(topSpace){
                $(".content").css({marginTop:topSpace})
            }
            $('#'+this.opts.viewPort).attr("content", "width=320, initial-scale=" + scaleFactor + ", maximum-scale=" + scaleFactor + ", user-scalable=no");
